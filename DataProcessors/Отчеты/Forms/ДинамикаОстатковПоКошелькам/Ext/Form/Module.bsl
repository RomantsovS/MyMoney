...
Процедура ОбновитьСерверСКД()
	...
	ОтчетыСКДВызовСервера.ПолучитьПараметрыНастроекСКД(СхемаКомпоновкиДанных, ЭтотОбъект.АдресНастроекСКД, , , СтруктураПараметров);
...
Процедура ОбновитьДиаграммуСервер() 
	...
	ОтчетыСКДВызовСервера.ПолучитьДанныеОтчета(СхемаКомпоновкиДанных, ДанныеОтчета, Неопределено, УникальныйИдентификатор,

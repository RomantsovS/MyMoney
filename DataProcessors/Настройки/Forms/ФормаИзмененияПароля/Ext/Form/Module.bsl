...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	ДопРеквизитыФормы.Вставить("ЦветТекстраОшибки", ЦветаСтиля.ЦветОтрицательногоЧисла);
	ДопРеквизитыФормы.Вставить("ЦветТекстраФормы", ЦветаСтиля.ЦветТекстаФормы);
...
Процедура ПроверитьПинКод()
	...
	Если ЗаполняемыйПинКод = 2 И ДлинаПароля2 = 4 Тогда
		...
		Иначе
			...
			Элементы.ДекорацияСообщение.ЦветТекста = ДопРеквизитыФормы.ЦветТекстраОшибки;
...
Процедура Подключаемый_ОчиститьПинКод()
	...
	Элементы.ДекорацияСообщение.ЦветТекста = ДопРеквизитыФормы.ЦветТекстраФормы;
	ОбновитьОтображениеПинКода();
	ЗаполняемыйПинКод = 1;
	НовыйПароль = "";
	ОбновитьОтображениеПинКода();

...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	ЗаполнитьЗначенияСвойств(ЭтотОбъект, Обработки.ЗагрузкаКурсовВалют.ПараметрыЗагрузкиКурсовВалют(),
	"НачалоПериодаЗагрузки, ОкончаниеПериодаЗагрузки"); 
	
	КлючОбъекта = Метаданные.Обработки.ЗагрузкаКурсовВалют.Имя;
	
	ТекНастройка = Обработки.ЗагрузкаКурсовВалют.ЗагрузитьОсновнуюНастройку();
	
	ЗаполнитьСписокВалютСервер();
	
	ОткрыватьЗагрузкуКурсовПриНачалеРаботы = Элементы.ОткрыватьЗагрузкуКурсовПриНачалеРаботы.СписокВыбора.Получить(Константы.ОткрыватьЗагрузкуКурсовПриНачалеРаботы.Получить());
КонецПроцедуры
...
Процедура ОткрыватьЗагрузкуКурсовПриНачалеРаботыПриИзменении(Элемент)
	ОткрыватьЗагрузкуКурсовПриНачалеРаботыПриИзмененииНаСервере();
КонецПроцедуры


&НаСервере
Процедура ОткрыватьЗагрузкуКурсовПриНачалеРаботыПриИзмененииНаСервере()
	Константы.ОткрыватьЗагрузкуКурсовПриНачалеРаботы.Установить(
	Элементы.ОткрыватьЗагрузкуКурсовПриНачалеРаботы.СписокВыбора.Индекс(
	Элементы.ОткрыватьЗагрузкуКурсовПриНачалеРаботы.СписокВыбора.НайтиПоЗначению(ОткрыватьЗагрузкуКурсовПриНачалеРаботы)));
КонецПроцедуры

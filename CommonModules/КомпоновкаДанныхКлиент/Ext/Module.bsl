...
Процедура ДиаграммаВыбор(Форма, Элемент, ЗначениеДиаграммы, СтандартнаяОбработка) Экспорт 
	...
	Если Форма.ДиаграммаПеревернута Тогда 
		...
		Форма.МассивОтборТекУровень.Добавить(ЗначениеДиаграммы.Точка.Значение);
	Иначе
		...
		Форма.МассивОтборТекУровень.Добавить(ЗначениеДиаграммы.Серия.Значение);
	КонецЕсли;
...
Процедура ОбработкаРасшифровки(Форма, Элемент, Расшифровка, АдресДанныхРасшифровки, СтандартнаяОбработка, ДопПараметры = Неопределено) Экспорт 
	...
	ДанныеРасшифровкиОтчета = ОтчетыСКДВызовСервера.ДанныеРасшифровкиОтчета(Расшифровка, АдресДанныхРасшифровки);
	...
	Если ДанныеРасшифровкиОтчета.ПараметрыДанных.Свойство("Периодичность") И 
		...
		ТекПериодПарам = ОтчетыСКДВызовСервера.ПолучитьДанныеПериодаПоПериодичности(ДанныеРасшифровкиОтчета.ПоляРасшифровкиРодители.Период,
	...
	ИначеЕсли ДанныеРасшифровкиОтчета.ПоляРасшифровкиРодители.Свойство("ПериодМесяц") Тогда 
		ТекПериодПарам = ОтчетыСКДВызовСервера.ПолучитьДанныеПериодаПоПериодичности(ДанныеРасшифровкиОтчета.ПоляРасшифровкиРодители.ПериодМесяц, "Месяц");
	КонецЕсли;

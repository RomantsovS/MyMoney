...
Процедура ИнициализироватьНастройкиГруппировки(ЭлементСтруктуры, СтруктураКомпоновки) Экспорт 
	...
	НоваяСтрокаукт = СтруктураКомпоновки.Добавить();
	
	Для Каждого ЭлементПолеГруппировки Из ЭлементСтруктуры.ПоляГруппировки.Элементы Цикл 
		НоваяСтрокаукт.Поле = ЭлементПолеГруппировки.Поле;
		НоваяСтрокаукт.Использование = ЭлементСтруктуры.Использование;
		НоваяСтрокаукт.Имя = ЭлементСтруктуры.Имя;
	КонецЦикла;

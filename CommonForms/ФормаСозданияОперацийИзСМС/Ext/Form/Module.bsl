...
Процедура УстановитьУсловноеОформление()
	...
	ЭлементОформления.Оформление.УстановитьЗначениеПараметра("ЦветФона", WebЦвета.РозовоКоричневый);
...
Процедура ОбработатьТаблицуВнешнихДанныхОпераций(ТЗ)
	...
	|		ЛЕВОЕ СОЕДИНЕНИЕ ВТ_ПоискОпераций КАК ВТ_ПоискОпераций
	|		ПО ОперацияТабл.Дата = ВТ_ПоискОпераций.Дата
	...
	|ГДЕ
	|	ВТ_ПоискОпераций.Операция.Дата МЕЖДУ &ДатаНачала И &ДатаОкончания");
	Запрос.УстановитьПараметр("ТЗ", ТЗ);
